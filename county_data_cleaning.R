...
# Import raw data
path1 <- "data/countypres_2000-2020.csv"
...
# write_csv(county_cleaned, "data/county_cleaned.csv")
...
# write_csv(merged, "data/county_merged.csv")
...
# write_csv(merged2, "data/county_census_merged.csv")
...
county_vax_raw <- read.csv(unz('data/county_vax.zip','county_vax.csv'), header = T)

county_vax_cleaned <- county_vax_raw %>% filter(Date == "05/31/2021")

# write_csv(county_vax_cleaned, "data/county_vax_cleaned.csv")

path5 <- "data/county_vax_cleaned2.csv"
...
write_csv(merged3, "data/county_census_vax.csv")
